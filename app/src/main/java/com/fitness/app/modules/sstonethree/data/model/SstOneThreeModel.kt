package com.fitness.app.modules.sstonethree.`data`.model

import com.fitness.app.R
import com.fitness.app.appcomponents.di.MyApp
import kotlin.String

data class SstOneThreeModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtPracticalAsses: String? =
      MyApp.getInstance().resources.getString(R.string.msg_practical_asses)
