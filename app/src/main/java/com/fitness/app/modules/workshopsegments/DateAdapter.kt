...
class DateAdapter(
    var dates: List<WorkShopSegmentResponses>,
    private val onDateSelected: (WorkShopSegmentResponses) -> Unit
    ...
    fun updateData(newDates: List<WorkShopSegmentResponses>) {
        dates = newDates
    ...
    inner class DateViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        @RequiresApi(Build.VERSION_CODES.N)
        fun bind(date: WorkShopSegmentResponses, isSelected: Boolean) {
