...
class WorkshopVideoAdapter(
var list: List<WorkshopVideoResponses>,
private val sessionManager: SessionManager
) : RecyclerView.Adapter<WorkshopVideoAdapter.RowPlyometricsVH>() {
    ...
    public fun updateData(newData: List<WorkshopVideoResponses>) {
        list = newData
    ...
    inner class RowPlyometricsVH(
        ...
        fun bindView(postModel: WorkshopVideoResponses) {
